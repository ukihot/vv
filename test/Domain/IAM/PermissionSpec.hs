...
case_definePermissionSeedsDraftPermission = do
    ...
    assertEqual
        "permission profile"
        (PermissionProfile permissionName permissionCode)
...
case_permissionLifecycle = do
    ...
    assertEqual
        "permission retired version"
        (PermissionVersion.Version 2)
        (getPermissionVersion retiredPermission)
